...
export default function Navbar() {
  ...
  const { customer, user, isAuthenticated, logout, role, activeVendorId } =
    useAuth();
  ...
  const menuLink = activeVendorId
    ? `/menu?vendorId=${activeVendorId}`
    : "/menu";
  ...
  const mobileNavLinkClass = (active) =>
    `text-base font-bold transition-colors p-3 rounded-xl ${
      active
        ...
        : "text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 hover:text-white"
    }`;
            ...
            <div className="hidden md:flex items-center gap-6">
              {customer ? (
                <>
                  ...
                  <Link
                    to="/wallet"
                    className={navLinkClass(location.pathname === "/wallet")}
                  >
                    Wallet
                  </Link>
                  <Link
                    to="/refer"
                    className={navLinkClass(location.pathname === "/refer")}
                  >
                    Referral
                  </Link>
                  <Link
                    to="/wishlist"
                    className={navLinkClass(location.pathname === "/wishlist")}
                  >
                    Wishlist
                    {wishlistCount > 0 && (
                ...
                <>
                  ...
                  {user?.vendorType === "salon" ? (
                    <Link
                      to="/vendor/services"
                      className={navLinkClass(
                        location.pathname === "/vendor/services",
                      )}
                    >
                      Manage Services
                    </Link>
                  ...
                  <Link
                    to="/upload-images"
                    className={navLinkClass(
                      location.pathname === "/upload-images",
                    )}
                  >
                    Upload Images
                  </Link>
              ...
              {itemCount > 0 && (
                ...
                >
                  ...
                  <span className="flex items-center gap-1">
                    ...
                    <span className="text-[#8cb800] dark:text-[#d4ff00] font-bold">
                      {itemCount}
                    </span>
                  </span>
                </button>
                    ...
                    {isDropdownOpen && (
                      ...
                      >
                        <div className="p-4 border-b border-zinc-100 dark:border-zinc-800">
                          <p className="text-xs font-black text-[#8cb800] dark:text-[#d4ff00] uppercase tracking-widest mb-1">
                            Guest Session
                          </p>
...
>
  Offers
                    ...
                    <div className="border-t border-zinc-700 mt-2 pt-3 px-3">
...
>
  Announcements
                  ...
                  <>
                    ...
                    <Link
                      to="/auth"
                      className="text-base font-black text-black bg-[#d4ff00] p-3 rounded-xl text-center mt-2 shadow-lg shadow-[#d4ff00]/20 active:scale-95 transition-transform"
                    >
                      Business Login
                    </Link>
                  </>
